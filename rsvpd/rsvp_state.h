 ...
 *-------------------------------------------------------------------------*/
void rsvp_state_recv_path(struct rsvp_ip_hdr_info *, struct rsvp_path_msg_info *, struct rsvp_if *);

void rsvp_state_recv_resv(struct rsvp_ip_hdr_info *, struct rsvp_resv_msg_info *, struct rsvp_if *);

void rsvp_state_recv_path_err(struct rsvp_ip_hdr_info *, struct rsvp_path_err_msg_info *,
			      struct rsvp_if *);

void rsvp_state_recv_resv_err(struct rsvp_ip_hdr_info *, struct rsvp_resv_err_msg_info *,
			      struct rsvp_if *);

void rsvp_state_recv_path_tear(struct rsvp_ip_hdr_info *, struct rsvp_path_tear_msg_info *,
			       struct rsvp_if *);

void rsvp_state_recv_resv_tear(struct rsvp_ip_hdr_info *, struct rsvp_resv_tear_msg_info *,
			       struct rsvp_if *);

void rsvp_state_recv_resv_conf(struct rsvp_ip_hdr_info *, struct rsvp_resv_conf_msg_info *,
			       struct rsvp_if *);

void rsvp_state_recv_hello_req(struct rsvp_ip_hdr_info *, struct rsvp_hello_msg_info *,
			       struct rsvp_if *);

void rsvp_state_recv_hello_ack(struct rsvp_ip_hdr_info *, struct rsvp_hello_msg_info *,
			       struct rsvp_if *);
