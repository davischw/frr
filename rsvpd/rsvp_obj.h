 ...
 *-------------------------------------------------------------------------*/
typedef enum { FLOWSPEC_INFO_CL = 1, FLOWSPEC_INFO_G = 2 } rsvp_flowspec_info_type_t;
 ...
 * Label Info Types.
 *--------------------------------------------------------------------------*/
typedef enum { LABEL_INFO_TYPE_GEN = 1 } rsvp_label_info_type_t;
 ...
 *--------------------------------------------------------------------------*/
typedef enum { SA_INFO_LSP_TUN = 1, SA_INFO_LSP_TUN_RA = 2 } rsvp_sa_info_type_t;
 ...
 *-------------------------------------------------------------------------*/
typedef enum { SCOPE_INFO_IPV4 = 1, SCOPE_INFO_IPV6 = 2 } rsvp_scope_info_type_t;
 ...
 *-----------------------------------------------------------------------*/
typedef enum { RESV_CONF_INFO_IPV4 = 1, RESV_CONF_INFO_IPV6 = 2 } rsvp_resv_conf_type_t;
 ...
 *-------------------------------------------------------------------------*/
typedef enum { RSVP_DETOUR_INFO_IPV4 = 1, RSVP_DETOUR_INFO_IPV6 = 2 } rsvp_detour_info_type_t;
 ...
 *--------------------------------------------------------------------------*/
int rsvp_obj_encode_hdr(struct stream *, u_int16_t, u_char, u_char);

int rsvp_obj_encode_integrity(struct stream *, struct rsvp_integrity_info *);

int rsvp_obj_encode_session(struct stream *, struct rsvp_session_info *);

int rsvp_obj_encode_st(struct stream *, struct rsvp_st_info *);

int rsvp_obj_encode_lro(struct stream *, struct rsvp_lro_info *);

int rsvp_obj_encode_label(struct stream *, struct rsvp_label_info *);

int rsvp_obj_encode_ero_subobj_hdr(struct stream *, u_char, u_char, u_char);

int rsvp_obj_encode_ero_subobj_ipv4_prefix(struct stream *, u_char, struct in_addr *, u_char);
#ifdef HAVE_IPV6
int rsvp_obj_encode_ero_subobj_ipv6_prefix(struct stream *, u_char, struct in6_addr *, u_char);
#endif
int rsvp_obj_encode_style_gen(struct stream *, u_char, u_int32_t);
int rsvp_obj_encode_frr(struct stream *, u_char *, u_char *, u_char *, u_char *, u_int32_t *,
			u_int32_t *, u_int32_t *, u_int32_t *);
/*----------------------------------------------------------------------------
 * The Object Decode Function Prototypes exported by this module.
 *--------------------------------------------------------------------------*/
int rsvp_obj_decode_hdr(struct stream *, u_int16_t *, u_char *, u_char *);

int rsvp_obj_decode_integrity(struct stream *, u_char, u_int16_t, struct rsvp_integrity_info *);

int rsvp_obj_decode_session(struct stream *, u_char, u_int16_t, struct rsvp_session_info *);

int rsvp_obj_decode_st(struct stream *, u_char, u_int16_t, struct rsvp_st_info *);

int rsvp_obj_decode_lro(struct stream *, u_char, u_int16_t, struct rsvp_lro_info *);

int rsvp_obj_decode_label(struct stream *, u_char, u_int16_t, struct rsvp_label_info *);

int rsvp_obj_decode_ero(struct stream *, u_char, u_int16_t, struct rsvp_ero_info_list *);

int rsvp_obj_decode_rro(struct stream *, u_char, u_int16_t, struct rsvp_rro_info_list *);

int rsvp_obj_decode_flt_spec(struct stream *, u_char, u_int16_t, struct rsvp_flt_spec_info *);

int rsvp_obj_decode_sa(struct stream *, u_char, u_int16_t, struct rsvp_sa_info *);

int rsvp_obj_decode_hop(struct stream *, u_char, u_int16_t, struct rsvp_hop_info *);

int rsvp_obj_decode_timeval(struct stream *, u_char, u_int16_t, struct rsvp_timeval_info *);

int rsvp_obj_decode_err_spec(struct stream *, u_char, u_int16_t, struct rsvp_err_spec_info *);

int rsvp_obj_decode_style(struct stream *, u_char, u_int16_t, struct rsvp_style_info *);

int rsvp_obj_decode_frr(struct stream *, u_char, u_int16_t, struct rsvp_frr_info *);

int rsvp_obj_decode_detour(struct stream *s, u_char, u_int16_t, struct rsvp_detour_info *);
