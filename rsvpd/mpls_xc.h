...
void mpls_xc_ilm_free(struct xc_ilm *);

struct xc_nhlfe *mpls_xc_nhlfe_new(void);

void mpls_xc_nhlfe_free(struct xc_nhlfe *);

struct xc_req *mpls_xc_req_new(void);

void mpls_xc_req_free(struct xc_req *);

int mpls_xc_add(void *, struct xc_req *, struct xc **);
int mpls_xc_update(void *, struct xc_req *, struct xc **);

struct xc *mpls_xc_lookup(void *);

int mpls_xc_delete(void *);
