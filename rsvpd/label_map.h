...
void label_map_free(struct label_map *);

void label_map_add_peer(struct label_map *, void *);

void label_map_delete_peer(struct label_map *, void *);

void *label_map_get_first_peer(struct label_map *);

unsigned int label_map_get_peer_count(struct label_map *);

int label_map_has_peer(struct label_map *, void *);
#endif
