 ...
 * Callers  : (TBD)..
 *---------------------------------------------------------------------------*/
struct labelmgr *labelmgr_init(u_int32_t start_label)
{
	if (start_label <= 16) {
 ...
 *--------------------------------------------------------------------------*/
static u_char hash_bitmask_alloc_bit(u_char *hash_bitmask)
{
 ...
 * Callers  : (TBD)..
 *--------------------------------------------------------------------------*/
u_int32_t labelmgr_alloc_label(struct labelmgr *labelmgr)
{
 ...
 * Callers  : (TBD).
 *---------------------------------------------------------------------------*/
void labelmgr_free_label(struct labelmgr *labelmgr, u_int32_t label)
{
	int hash_bucket;
	int bit_mask = 1;
	/* Sanity Check. */
