 ...
 *            initialization.  
 *--------------------------------------------------------------------------*/
struct rsvp *rsvp_create(char *name)
{
	struct rsvp *rsvp;
 ...
 *------------------------------------------------------------------------*/
struct rsvp_ip_hop *rsvp_ip_hop_create(int hop_type, struct prefix *hop)
{
 ...
 *------------------------------------------------------------------------*/
struct rsvp_ip_path *rsvp_ip_path_create(char *name)
{
	...
	ternary_insert((ternary_tree *)&rsvp->ip_path_obj, name, rsvp_ip_path, 0);
	listnode_add((struct list *)rsvp->ip_path_list, rsvp_ip_path);
 ...
 * Callers  : (TBD).
 *--------------------------------------------------------------------------*/
struct rsvp_ip_path *rsvp_ip_path_search(char *name)
{
 ...
 *--------------------------------------------------------------------------*/
int rsvp_ip_path_delete(char *name)
{
	//struct rsvp_ip_path *rsvp_ip_path;
 ...
 *-------------------------------------------------------------------------*/
int rsvp_ip_path_insert_hop(struct rsvp_ip_path *rsvp_ip_path, int hop_type, struct prefix *hop)
{
	struct rsvp_ip_hop *rsvp_ip_hop;
 ...
 * Callers  : CLI Handlers of this module in rsvp_vty.c
 *------------------------------------------------------------------------*/
int rsvp_ip_path_delete_hop(struct rsvp_ip_path *rsvp_ip_path, int hop_type, struct prefix *hop)
{
 ...
 *-------------------------------------------------------------------------*/
int rsvp_tunnel_if_avl_key_cmp(const void *in_key, const void *data, void *param)
{
...
void *rsvp_tunnel_if_obj_init(void)
{
	...
	avl_t_init(&rsvp_tunnel_if_obj.rsvp_tunnel_if_avl_table_traverser, rsvp_tunnel_if_avl_table);
 ...
 *-------------------------------------------------------------------------*/
struct rsvp_tunnel_if *rsvp_tunnel_if_create(u_int32_t tunnel_if_num)
{
	...
	rsvp_tunnel_if = XCALLOC(MTYPE_RSVP_TUNNEL_IF, sizeof(struct rsvp_tunnel_if));
	...
	result = avl_insert((struct avl_table *)tunnel_if_obj->rsvp_tunnel_if_avl_table,
			    rsvp_tunnel_if);
 ...
 *-------------------------------------------------------------------------*/
struct rsvp_tunnel_if *rsvp_tunnel_if_search(u_int32_t tunnel_num)
{
	...
	rsvp_tunnel_if =
		(struct rsvp_tunnel_if *)avl_find(rsvp_tunnel_if_obj->rsvp_tunnel_if_avl_table,
						  &tunnel_num);
 ...
 *--------------------------------------------------------------------------*/
struct rsvp_tunnel_if *rsvp_tunnel_if_traverse(int flag)
{
	struct rsvp_tunnel_if_obj *rsvp_tunnel_if_obj =
		(struct rsvp_tunnel_if_obj *)rm->rsvp->tunnel_if_obj;

	struct avl_traverser *traverser = &rsvp_tunnel_if_obj->rsvp_tunnel_if_avl_table_traverser;
 ...
 *-------------------------------------------------------------------------*/
int rsvp_tunnel_if_delete(u_int32_t tunnel_num)
{
	struct rsvp_tunnel_if_obj *rsvp_tunnel_if_obj;
	struct avl_table *rsvp_tunnel_if_avl_table;
	struct rsvp_tunnel_if *rsvp_tunnel_if;
 ...
 * Callers  :
 *-------------------------------------------------------------------------*/
int rsvp_tunnel_if_is_config_complete(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return 0;
 ...
 *--------------------------------------------------------------------------*/
void rsvp_tunnel_if_set_rsvp(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return;
 ...
 *--------------------------------------------------------------------------*/
void rsvp_tunnel_if_unset_rsvp(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return;
 ...
 *-------------------------------------------------------------------------*/
void rsvp_tunnel_if_set_cspf(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity check. */
	if (!rsvp_tunnel_if)
		return;
 ...
 *--------------------------------------------------------------------------*/
void rsvp_tunnel_if_unset_cspf(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return;
 ...
 * Callers  : CLI Handlers of this module in rsvp_vty.c
 *--------------------------------------------------------------------------*/
void rsvp_tunnel_if_set_dst(struct rsvp_tunnel_if *rsvp_tunnel_if, struct prefix *dst)
{
	/* Sanity Check. */
 ...
 * Callers  : CLI Handlers defined in this module in rsvp_vty.c
 *--------------------------------------------------------------------------*/
void rsvp_tunnel_if_unset_dst(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return;
 ...
 *--------------------------------------------------------------------------*/
void rsvp_tunnel_if_set_path_option(struct rsvp_tunnel_if *rsvp_tunnel_if, int path_option_num,
				    int path_option_type, int standby_flag,
 ...
 *-------------------------------------------------------------------------*/
void rsvp_tunnel_if_unset_path_option(struct rsvp_tunnel_if *rsvp_tunnel_if, int path_option_num)
{
	struct rsvp_tunnel_if_path_option *path_option;
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
	...
	if (path_option->rsvp_lsp_handle) {
		...
		((struct rsvp_lsp *)path_option->rsvp_lsp_handle)->ingress_user_handle = NULL;
 ...
 * Callers  :
 *--------------------------------------------------------------------------*/
int rsvp_tunnel_if_path_option_is_valid(struct rsvp_tunnel_if *rsvp_tunnel_if, int path_option_num)
{
	/* Sanity Check. */
 ...
 *---------------------------------------------------------------------------*/
void rsvp_tunnel_if_path_option_select_active(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return;
 ...
 *--------------------------------------------------------------------------*/
void rsvp_tunnel_if_admin_up(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return;
 ...
 *--------------------------------------------------------------------------*/
void rsvp_tunnel_if_admin_down(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return;
 ...
 * Callers  : CLI Handlers of this module in rsvp_vty.c.
 *-------------------------------------------------------------------------*/
void rsvp_tunnel_if_start(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return;
	...
	if (RSVP_TUNNEL_IF_IS_ADMIN_UP(rsvp_tunnel_if) && RSVP_TUNNEL_IF_IS_COMPLETE(rsvp_tunnel_if))
 ...
 * Callers  : CLI Handlers of this module in rsvp_vty.c.
 *-------------------------------------------------------------------------*/
void rsvp_tunnel_if_stop(struct rsvp_tunnel_if *rsvp_tunnel_if)
{
	/* Sanity Check. */
	if (!rsvp_tunnel_if)
		return;
