 ...
 * Function Prototypes 
 *--------------------------------------------------------------------------*/
void rsvp_packet_output_forward(struct stream *, size_t);
...
void rsvp_packet_fifo_push(struct rsvp_packet_fifo *, struct rsvp_packet *);
...
void rsvp_packet_add_to_if(struct rsvp_if *, struct rsvp_packet *);
void rsvp_packet_del_from_if(struct rsvp_if *);

struct stream *rsvp_stream_copy(struct stream *, struct stream *);

void rsvp_packet_decode_msg_hdr(struct stream *, struct rsvp_msg_hdr *);
int rsvp_packet_verify_checksum(struct rsvp_msg_hdr *);
int rsvp_packet_verify_msg_hdr(struct rsvp_packet *, struct rsvp_if *, struct rsvp_msg_hdr *);

/* Specific Message Handler Routines. */
void rsvp_packet_path_receive(struct rsvp_msg_hdr *, struct rsvp_packet *, struct rsvp_if *);

void rsvp_packet_resv_receive(struct rsvp_msg_hdr *, struct rsvp_packet *, struct rsvp_if *);

void rsvp_packet_path_err_receive(struct rsvp_msg_hdr *, struct rsvp_packet *, struct rsvp_if *);

void rsvp_packet_resv_err_receive(struct rsvp_msg_hdr *, struct rsvp_packet *, struct rsvp_if *);

void rsvp_packet_path_tear_receive(struct rsvp_msg_hdr *, struct rsvp_packet *, struct rsvp_if *);

void rsvp_packet_resv_tear_receive(struct rsvp_msg_hdr *, struct rsvp_packet *, struct rsvp_if *);

void rsvp_packet_resv_conf_receive(struct rsvp_msg_hdr *, struct rsvp_packet *, struct rsvp_if *);

void rsvp_packet_hello_receive(struct rsvp_msg_hdr *, struct rsvp_packet *, struct rsvp_if *);

void rsvp_packet_bundle_receive(struct rsvp_msg_hdr *, struct rsvp_packet *, struct rsvp_if *);
 ...
 *--------------------------------------------------------------------------*/
void rsvp_packet_send_path(struct rsvp_ip_hdr_info *, struct rsvp_path_msg_info *, struct in_addr *,
			   struct rsvp_if *);

void rsvp_packet_send_resv(struct rsvp_ip_hdr_info *, struct rsvp_resv_msg_info *, struct in_addr *,
			   struct rsvp_if *);

void rsvp_packet_send_path_err(struct rsvp_ip_hdr_info *, struct rsvp_path_err_msg_info *,
			       struct in_addr *, struct rsvp_if *);

void rsvp_packet_send_resv_err(struct rsvp_ip_hdr_info *, struct rsvp_resv_err_msg_info *,
			       struct in_addr *, struct rsvp_if *);

void rsvp_packet_send_path_tear(struct rsvp_ip_hdr_info *, struct rsvp_path_tear_msg_info *,
				struct in_addr *, struct rsvp_if *);

void rsvp_packet_send_resv_tear(struct rsvp_ip_hdr_info *, struct rsvp_resv_tear_msg_info *,
				struct in_addr *, struct rsvp_if *);

void rsvp_packet_send_resv_conf(struct rsvp_ip_hdr_info *, struct rsvp_resv_conf_msg_info *,
				struct in_addr *, struct rsvp_if *);

void rsvp_packet_send_hello_req(struct rsvp_ip_hdr_info *, struct rsvp_hello_msg_info *,
				struct in_addr *, struct rsvp_if *);

void rsvp_packet_send_hello_ack(struct rsvp_ip_hdr_info *, struct rsvp_hello_msg_info *,
				struct in_addr *, struct rsvp_if *);
