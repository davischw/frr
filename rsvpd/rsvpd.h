...
typedef enum { RSVP_IP_HOP_STRICT = 0, RSVP_IP_HOP_LOOSE = 1 } rsvp_ip_hop_type;
...
#define RSVP_TUNNEL_IF_CFLAG_COMPLETE                                                              \
	(1 << 3) /* Tunnel config is complete
...
#define RSVP_TUNNEL_IF_IS_RSVP_SET(X) CHECK_FLAG(X->cflags, RSVP_TUNNEL_IF_CFLAG_RSVP)
...
#define RSVP_TUNNEL_IF_IS_CSPF_SET(X) CHECK_FLAG(X->cflags, RSVP_TUNNEL_IF_CFLAG_CSPF)
...
#define RSVP_TUNNEL_IF_IS_DST_SET(X) CHECK_FLAG(X->cflags, RSVP_TUNNEL_IF_CFLAG_DST)
...
#define RSVP_TUNNEL_IF_IS_COMPLETE(X) (CHECK_FLAG(X->cflags, RSVP_TUNNEL_IF_CFLAG_COMPLETE))
...
#define RSVP_TUNNEL_IF_IS_ADMIN_UP(X) (CHECK_FLAG(X->sflags, RSVP_TUNNEL_IF_SFLAG_ADMIN_UP))
...
#define RSVP_TUNNEL_IF_IS_ACTIVE(X) (CHECK_FLAG(X->sflags, RSVP_TUNNEL_IF_SFLAG_ACTIVE))
...
struct rsvp_ip_hop *rsvp_ip_hop_create(int, struct prefix *);
...
int rsvp_ip_path_insert_hop(struct rsvp_ip_path *, int, struct prefix *);
int rsvp_ip_path_delete_hop(struct rsvp_ip_path *, int, struct prefix *);
...
void rsvp_tunnel_if_switch_lsp(struct rsvp_tunnel_if *, int);
...
void rsvp_tunnel_if_set_path_option(struct rsvp_tunnel_if *, int, int, int, struct rsvp_ip_path *);
void rsvp_tunnel_if_unset_path_option(struct rsvp_tunnel_if *, int);
int rsvp_tunnel_if_path_option_is_valid(struct rsvp_tunnel_if *, int);
