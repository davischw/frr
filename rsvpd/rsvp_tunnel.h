...
void rsvp_tunnel_add(char *, u_char, struct prefix *);

void rsvp_tunnel_delete(struct rsvp_tunnel *);

void rsvp_tunnel_add_lsp(struct rsvp_tunnel *, struct rsvp_lsp *);

void rsvp_tunnel_delete_lsp(struct rsvp_tunnel *, struct rsvp_lsp *);
